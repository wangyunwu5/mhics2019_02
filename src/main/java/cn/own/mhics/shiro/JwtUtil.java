...
import cn.own.mhics.tools.Base64ConvertUtil;
...
public class JwtUtil {
	...
	public static String  sign(String account,String currentTimeMillis) {
		try {
			...
			logger.error("JWTToken加密出现UnsupportedEncodingExceptioon异常:"+e.getMessage());
			throw new CustomException("JWTToken加密出现UnsupportedEncodingExceptioon异常:"+e.getMessage());
		}
	}
}
